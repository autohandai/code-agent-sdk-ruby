...
module AutohandSDK
  ...
  autoload :SESSION_HISTORY_STATUSES, "autohand_sdk/rpc_types"
  autoload :SessionHistoryParams, "autohand_sdk/rpc_types"
  autoload :SessionHistoryEntry, "autohand_sdk/rpc_types"
  autoload :SessionHistoryResult, "autohand_sdk/rpc_types"
  autoload :SessionDetailsParams, "autohand_sdk/rpc_types"
  autoload :SESSION_MESSAGE_ROLES, "autohand_sdk/rpc_types"
  autoload :SessionMessageToolCall, "autohand_sdk/rpc_types"
  autoload :SessionMessage, "autohand_sdk/rpc_types"
  ...
  autoload :YoloSetParams, "autohand_sdk/rpc_types"
  autoload :YoloSetResult, "autohand_sdk/rpc_types"
  autoload :MCPInputSchema, "autohand_sdk/rpc_types"
  ...
  autoload :LearnRecommendParams, "autohand_sdk/rpc_types"
  autoload :LEARN_AUDIT_STATUSES, "autohand_sdk/rpc_types"
  autoload :LearnAuditEntry, "autohand_sdk/rpc_types"
  autoload :LearnRecommendation, "autohand_sdk/rpc_types"
  autoload :LearnRecommendResult, "autohand_sdk/rpc_types"
  autoload :LearnUpdateParams, "autohand_sdk/rpc_types"
  autoload :LEARN_UPDATE_STATUSES, "autohand_sdk/rpc_types"
  autoload :LearnUpdateEntry, "autohand_sdk/rpc_types"
  autoload :LearnUpdateResult, "autohand_sdk/rpc_types"
  autoload :LEARN_GENERATE_SCOPES, "autohand_sdk/rpc_types"
  autoload :LearnGenerateParams, "autohand_sdk/rpc_types"
  autoload :LearnGenerateResult, "autohand_sdk/rpc_types"
  autoload :ToolsRegistryParams, "autohand_sdk/rpc_types"
  autoload :TOOL_REGISTRY_SOURCES, "autohand_sdk/rpc_types"
  autoload :TOOL_REGISTRY_SCOPES, "autohand_sdk/rpc_types"
  ...
  autoload :MCPInvokeRequestEvent, "autohand_sdk/rpc_types"
  autoload :MCPToolsChangedEntry, "autohand_sdk/rpc_types"
  autoload :MCPToolsChangedEvent, "autohand_sdk/rpc_types"
